class UserServices::UpdateUserTest < Minitest::Test
  ...
  def test_unit_should_edit_user_without_password_and_without_permissions
  ...
  def test_unit_should_edit_user_with_password_and_without_permissions
    @user_instance_mock.expect(:username=, nil, [ @faked_username ])
  ...
  def test_unit_should_edit_user_without_password_and_with_permissions
    @user_instance_mock.expect(:username=, nil, [ @faked_username ])
    @user_instance_mock.expect(:full_name=, nil, [ @faked_full_name ])
  ...
  def test_unit_should_edit_user_with_password_and_with_permissions
    @user_instance_mock.expect(:username=, nil, [ @faked_username ])
    @user_instance_mock.expect(:password=, nil, [ @faked_password ])
    @user_instance_mock.expect(:password_confirmation=, nil, [ @faked_password_confirmation ])
    @user_instance_mock.expect(:full_name=, nil, [ @faked_full_name ])
  ...
  def test_unit_should_return_no_error_when_user_is_saved
    @user_instance_mock.expect(:username=, nil, [ @faked_username ])
    @user_instance_mock.expect(:full_name=, nil, [ @faked_full_name ])
    @user_instance_mock.expect(:role, "OPERATOR")
    @user_instance_mock.expect(:role, "OPERATOR")
  ...
  def test_unit_should_return_error_when_user_is_not_saved
    @user_instance_mock.expect(:username=, nil, [ @faked_username ])
    @user_instance_mock.expect(:full_name=, nil, [ @faked_full_name ])
    @user_instance_mock.expect(:role, "OPERATOR")
    @user_instance_mock.expect(:role, "OPERATOR")
